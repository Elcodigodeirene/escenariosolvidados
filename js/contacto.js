/** contacto.js - Página de Hallazgos
 * ----------------------------------------------------------------------
 * Este archivo gestiona la interactividad de la página de Hallazgos, incluyendo:
...
(() => {
  ...
  const botones = document.querySelectorAll('.Header-a, .Footer-up, .Footer-links, .Footer-coordinates--trigger, .Contact-btn ')
